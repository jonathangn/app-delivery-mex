...
const CheckoutDetails = ({ setModal }) => {
  ...
  return (
    <div>
      {successMsg ? <div className="flex flex-col justify-center items-center h-[100vh] lg:h-[600px] px-6"><h2 className="text-2xl font-semibold text-center ">Thank you! The order has been placed!</h2>
            ...
            <div className="flex-1 h-full overflow-y-auto lg:overflow-visible py-4 px-8 lg:py-0 lg:px-0 overflow-y-scroll overflow-hidden scrollbar-thin scrollbar-thumb-gray-100 scrollbar-track-white-500">
              <div className="flex flex-col gap-4 h-full">
                <div className="flex flex-col lg:flex-row justify-between gap-4 lg:gap-0 lg:gap-x-4 ">
                  <input type="text" className="w-full input" placeholder="First Name"></input>
                  <input type="text" className="w-full input" placeholder="Last Name"></input>
                </div>

                <div className="flex flex-col lg:flex-row justify-between gap-4 lg:gap-0 lg:gap-x-4 ">
                  <input type="text" className="w-full input" placeholder="Phone"></input>
                  <input type="text" className="w-full input" placeholder="Email"></input>
                </div>

                <div className="flex flex-col lg:flex-row justify-between gap-4 lg:gap-0 lg:gap-x-4 ">
                  <input type="text" className="w-full input" placeholder="Street"></input>
                  <input type="text" className="w-full input" placeholder="Apt / Off."></input>
                </div>
