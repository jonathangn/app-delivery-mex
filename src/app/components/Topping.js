...
const Topping = ({ topping, additionalTopping, setAdditionalTopping }) => {
  ...
  return <div className={`${isChecked && 'border-orange'} w-full max-w-[110px] h-[140px] p-1 flex flex-col items-center justify-center border rounded-md bg-white relative`}>
